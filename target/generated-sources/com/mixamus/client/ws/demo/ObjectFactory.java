 ...
 * generated in the com.mixamus.client.ws.demo package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://ws.servers.mixamus.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://ws.servers.mixamus.com/", "helloWorldResponse");
    private final static QName _Hi_QNAME = new QName("http://ws.servers.mixamus.com/", "hi");
    private final static QName _HiResponse_QNAME = new QName("http://ws.servers.mixamus.com/", "hiResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mixamus.client.ws.demo
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.servers.mixamus.com/", name = "helloWorld")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.servers.mixamus.com/", name = "helloWorldResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.servers.mixamus.com/", name = "hi")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.servers.mixamus.com/", name = "hiResponse")
